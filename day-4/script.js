...
function partTwoB () {
  ...
  let flavors = ["Chocolate", "Mint Chocolate Chip", "Oreo", "Strawberry", "Vanilla"]; 
  // 2. Find the length of the array
  let highNumber = flavors.length;
  // 3. Create a for loop.
  for (let i = 0; i < highNumber; i++) {
    // 4. give the user and alert with the current friend.
    alert(`The current flavor is ${flavors[i]}.`);
  }
}
...
// Try to loop over favorite flavors
function partThreeB () {
  messageParagraph.innerHTML = "Try it!";
  messageParagraph.innerHTML = "Flavors";
  // 1. create an array of 5 flavors
  let flavors = ["Chocolate", "Mint Chocolate Chip", "Oreo", "Strawberry", "Vanilla"];
  // 2. find the length of the array
...
function partFourB () {
  ...
  newFlavor = prompt("What flavor would you like?"); 
